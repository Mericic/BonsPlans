...
<div class="container">
    ...
    <div class="row justify-content-center">
        <div class="btn-group" role="group" aria-label="Basic example">
            <button type="button" class="btn btn-secondary" onclick="showDivs(1)">Categories Favorites</button>
            <button type="button" class="btn btn-secondary" onclick="showDivs('com-historique')">Commentaires</button>
            <button type="button" class="btn btn-secondary" onclick="showDivs('participation')">Activite</button>
            <button type="button" class="btn btn-secondary" onclick="showDivs('creation')">Creations</button>
        </div>
    </div>
    <div class="row justify-content-center">
        <div id="main-frame" class="col-8">
            <div class="w3-content w3-display-container w3-animate-opacity">
                <div id="1" class="mySlides">
                    <div class="row justify-content-center">
                        <div class="col-5 profil-progress">
                            <p>Categorie 1</p>
                            <div class="progress">
                ...
                <div id="com-historique" class="mySlides">
                    @foreach ($commentaires as $commentaire)
                        <div class="profil-com col-7" style="margin: auto">
                ...
                <div id="participation" class="mySlides" style="margin: auto">
                    <div class="row justify-content-center">
                        <div class="participation-div col-5">
                            <p class="participation-title">Participation-Title</p>
                            <div class="participation-info"> 
                                <div class="row justify-content-center"> 
                                    <div class="progress .participation-bar col-5">
